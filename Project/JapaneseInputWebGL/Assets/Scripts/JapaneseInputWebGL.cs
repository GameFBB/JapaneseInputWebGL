...
public class JapaneseInputWebGL : MonoBehaviour
{
    ...
    [SerializeField] private Text TextCandidate6;
    ...
    void Update()
    {
            ...
            Application.platform == RuntimePlatform.WindowsEditor)
        {
            ...
            if (Input.GetKeyUp(KeyCode.Space))
            {
                ...
                {
                    //ひらがなに変換
                    Placeholder.text = ConvertToHiragana(TextField.text);
    ...
    public void ClickCandidateButtons(int SelectNumber)
    {
        ...
        {
            case 6:
                Placeholder.text = Placeholder.text.Replace(TextCandidate[0], TextCandidate[0]);
                break;
            default:
    ...
    public void OnEndEdit()
    {
        ...
        {
            AddText = TextField.text.Replace(Result, "");
            RomanText = RomanText + AddText;
        }

        //出力
        Debug.Log("Before：" + RomanText);
